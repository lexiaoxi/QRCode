...
(function() {
     ...
     */
    QRCode = function(el,el2,el3,el4,vOption) {
        this._htOption = {
            width: 256,
            height: 256,
            typeNumber: 4,
        ...
        if (this._htOption.text) {
            ...
            //没有自行设置链接则转换当前url的二维码
            this.makeCode(location.href);
        }*/
        //链接切换
        var that=this;
        var changeQRCode=function(){
            var address=el4.value;
            if(address!=""){
                that.makeCode(address);
            }
            ...
            var historyLinkBox=createSingleBox(),
                historyList = '';                
            for(var i=0,len=historyDif.length;i<len; i++){
                historyList += '<li><a href="javascript:">'+historyDif[i]+'</a></li>';
            }
            ...
            el3.addEventListener("click",function(){
                historyLinkBox.innerHTML="";
                localStorage.clear();
            },false);
        };
        changeQRCode();
        el2.addEventListener("click",changeQRCode,false);        
    };
